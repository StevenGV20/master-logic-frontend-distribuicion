...
import { MANTENIMIENTO_DISTANCIAS_TABLE_COLS_DESKTOP, URL_MASTERLOGIC_API } from "../utils/general";
...
const MantenimientoDistanciasPage = () => {
  ...
  return (
    <div className="page-container">
      ...
      <div>
        <TableCustom cols={MANTENIMIENTO_DISTANCIAS_TABLE_COLS_DESKTOP}></TableCustom>
      </div>
    </div>
  );
}
